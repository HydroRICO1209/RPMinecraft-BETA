...
''',
                ...
                elif item.pogchop >= 50 and item.coal >= 50:
                    db[stats.userid + 'pogchop'] -= 50
                    db[stats.userid + 'coal'] -= 50
                    db[stats.userid + 'helmet'] = 1
                    await ctx.send(f'**{ctx.author.name}**, poghelmet is crafted')
                else:
                    await ctx.send(f'You only have **{item.pogchop} pogchops** and **{item.coal} coals**')
                atk_def(ctx)
    
            elif arg == 'pog chestplate':
                if stats.chestplate == 1:
                    await ctx.send('You will regret, check your inv :D')
                elif item.pogchop >= 80 and item.coal >= 80:
                    db[stats.userid + 'pogchop'] = item.pogchop - 80
                    db[stats.userid + 'coal'] = item.coal - 80
                    db[stats.userid + 'chestplate'] = 1
                    await ctx.send(f'**{ctx.author.name}**, pog chestplate is crafted')
                else:
                    await ctx.send(f'You only have **{item.pogchop} pogchops** and **{item.coal} coals**')
                atk_def(ctx)
                ...
                if stats.leggings == 1:
                    await ctx.send('You will regret, check your inv :D')
                elif item.pogchop >= 70 and item.coal >= 70:
                    db[stats.userid + 'pogchop'] = item.pogchop - 70
                    db[stats.userid + 'coal'] = item.coal - 70
                    db[stats.userid + 'leggings'] = 1
                    await ctx.send(f'**{ctx.author.name}**, pog leggings is crafted')
                else:
                    await ctx.send(f'You only have **{item.pogchop} pogchops** and **{item.coal} coals**')
                atk_def(ctx)
                ...
                if stats.boots == 1:
                    await ctx.send('You will regret, check your inv :D')
                if item.pogchop >= 40 and item.coal >= 40:
                    db[stats.userid + 'pogchop'] = item.pogchop - 40
                    db[stats.userid + 'coal'] = item.coal - 40
                    db[stats.userid + 'boots'] = 1
                    await ctx.send(f'**{ctx.author.name}**, pog boots is crafted')
                else:
                    await ctx.send(f'You only have **{item.pogchop} pogchops** and **{item.coal} coals**')
                atk_def(ctx)
                ...
                if stats.sword == 1:
                    await ctx.send('You will regret, check your inv :D')
                elif item.pogchop >= 20 and item.coal >= 20:
                    db[stats.userid + 'pogchop'] = item.pogchop - 20
                    db[stats.userid + 'coal'] = item.coal - 20
                    db[stats.userid + 'sword'] = 1
                    await ctx.send(f'**{ctx.author.name}**, pog sword is crafted')
                else:
                    await ctx.send(f'You only have **{item.pogchop} pogchops** and **{item.coal} coals**')
                atk_def(ctx)
                ...
                if stats.sword == 69:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, beefy sword is crafted')
                else:
                ...
                if stats.helmet == 2:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, iron helmet is crafted')
                elif item.iron_ingot < 50:
                ...
                if stats.chestplate == 2:
                    ...
                    await ctx.send(f'**{ctx.author.name}**,iron chestplate is crafted')
                elif item.iron_ingot < 80:
                    await ctx.send(f'You only have **{item.iron_ingot} iron_ingot**')
                atk_def(ctx)
                ...
                if stats.leggings == 2:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, iron leggings is crafted')
                elif item.iron_ingot < 70:
                    await ctx.send(f'You only have **{item.iron_ingot} iron_ingot**')
                atk_def(ctx)
                ...
                if stats.boots == 2:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, iron boots is crafted')
                elif item.iron_ingot < 40:
                    await ctx.send(f'You only have **{item.iron_ingot} iron_ingot**')
                atk_def(ctx)
                ...
                if stats.sword == 2:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, iron sword is crafted')
                elif item.iron_ingot < 20:
                    await ctx.send(f'You only have **{item.iron_ingot} iron_ingot**')
                atk_def(ctx)
                ...
                if stats.helmet == 3:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, diamond helmet is crafted')
                elif item.diamond < 50:
                ...
                if stats.chestplate == 3:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, diamond chestplate is crafted')
                elif item.diamond < 80:
                    await ctx.send(f'You only have **{item.diamond} diamond**')
                atk_def(ctx)
                ...
                if stats.leggings == 3:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, diamond leggings is crafted')
                elif item.diamond < 70:
                    await ctx.send(f'You only have **{item.diamond} diamond**')
                atk_def(ctx)
                ...
                if stats.boots == 3:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, diamond boots is crafted')
                elif item.diamond < 40:
                    await ctx.send(f'You only have **{item.diamond} diamond**')
                atk_def(ctx)
                ...
                if stats.sword == 3:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, diamond sword is crafted')
                elif item.diamond < 20:
                    await ctx.send(f'You only have **{item.diamond} diamond**')
                atk_def(ctx)
                ...
                if stats.helmet == 4:
                    await ctx.send('You will regret, check your inv :D')
                elif item.pogchop >= 40 and item.beef >= 40 and item.wool >= 40 and stats.helmet == 3:
                    db[stats.userid + 'pogchop'] = item.pogchop - 40
                    db[stats.userid + 'beef'] = item.beef - 40
                    db[stats.userid + 'wool'] = item.wool - 40
                    db[stats.userid + 'helmet'] = 4
                    await ctx.send(f'**{ctx.author.name}**, meaty wooly diamond helmet is crafted')
                elif item.pogchop < 40:
                    await ctx.send(f'You only have **{item.pogchop} pogchop**')
                elif item.beef < 40:
                ...
                if stats.chestplate == 4:
                    await ctx.send('You will regret, check your inv :D')
                elif item.pogchop >= 80 and item.beef >= 80 and item.wool >= 80 and stats.chestplate == 3:
                    db[stats.userid + 'pogchop'] = item.pogchop - 80
                    db[stats.userid + 'beef'] = item.beef - 80
                    db[stats.userid + 'wool'] = item.wool - 80
                    db[stats.userid + 'chestplate'] = 4
                    await ctx.send(f'**{ctx.author.name}**, meaty wooly diamond chestplate is crafted')
                elif item.pogchop < 80:
                    await ctx.send(f'You only have **{item.pogchop} pogchop**')
                elif item.beef < 80:
                    await ctx.send(f'You only have **{item.beef} beef**')
                elif item.wool < 80:
                ...
                if stats.leggings == 4:
                    await ctx.send('You will regret, check your inv :D')
                elif item.pogchop >= 70 and item.beef >= 70 and item.wool >= 70 and stats.leggings == 3:
                    db[stats.userid + 'pogchop'] = item.pogchop - 70
                    db[stats.userid + 'beef'] = item.beef - 70
                    db[stats.userid + 'wool'] = item.wool - 70
                    db[stats.userid + 'leggings'] = 4
                    await ctx.send(f'**{ctx.author.name}**, meaty wooly diamond leggings is crafted')
                elif item.pogchop < 70:
                    await ctx.send(f'You only have **{item.pogchop} pogchop**')
                elif item.beef < 70:
                    await ctx.send(f'You only have **{item.beef} beef**')
                elif item.wool < 70:
                ...
                if stats.boots == 4:
                    await ctx.send('You will regret, check your inv :D')
                elif item.pogchop >= 40 and item.beef >= 40 and item.wool >= 40 and stats.boots == 3:
                    db[stats.userid + 'pogchop'] = item.pogchop - 40
                    db[stats.userid + 'beef'] = item.beef - 40
                    db[stats.userid + 'wool'] = item.wool - 40
                    db[stats.userid + 'boots'] = 4
                    await ctx.send(f'**{ctx.author.name}**, meaty wooly diamond boots is crafted')
                elif item.pogchop < 40:
                    await ctx.send(f'You only have **{item.pogchop} pogchop**')
                elif item.beef < 40:
                    await ctx.send(f'You only have **{item.beef} beef**')
                ...
                if stats.sword == 4:
                    await ctx.send('You will regret, check your inv :D')
                elif item.pogchop >= 20 and item.beef >= 20 and item.wool >= 20 and stats.sword == 3:
                    db[stats.userid + 'pogchop'] = item.pogchop - 20
                    db[stats.userid + 'beef'] = item.beef - 20
                    db[stats.userid + 'wool'] = item.wool - 20
                    db[stats.userid + 'sword'] = 4
                    await ctx.send(f'**{ctx.author.name}**, meaty wooly diamond sword is crafted')
                elif item.pogchop < 20:
                    await ctx.send(f'You only have **{item.pogchop} pogchop**')
                elif item.beef < 20:
                    await ctx.send(f'You only have **{item.beef} beef**')
                elif item.wool < 20:
                ...
                if stats.helmet == 5:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, shiny meaty wooly diamond helmet is crafted')
                ...
                if stats.chestplate == 5:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, shiny meaty wooly diamond chestplate is crafted')
                ...
                if stats.leggings == 5:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, shiny meaty wooly diamond leggings is crafted')
                ...
                if stats.boots == 5:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, shiny meaty wooly diamond boots is crafted')
                ...
                if stats.sword == 5:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, shiny meaty wooly diamond sword is crafted')
                ...
                if stats.helmet == 6:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, shiny meaty wooly netherite helmet is crafted')
                ...
                if stats.chestplate == 6:
                    ...
                    await ctx.send(f'**{ctx.author.name}**,shiny meaty wooly netherite chestplate is crafted')
                elif item.netherite_ingot < 1:
                ...
                if stats.leggings == 6:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, shiny meaty wooly netherite leggings is crafted')
                elif item.netherite_ingot < 1:
                ...
                if stats.boots == 6:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, shiny meaty wooly netherite boots is crafted')
                elif item.netherite_ingot < 1:
                    await ctx.send('You dont have a ** netherite_ingot**')
                elif stats.boots != 5:
                ...
                if stats.sword == 6:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, shiny meaty wooly netherite sword is crafted')
                elif item.netherite_ingot < 1:
                    await ctx.send('You dont have a ** netherite_ingot**')
                elif stats.sword != 5:
                ...
                if stats.helmet == 7:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, more shiny meaty wooly netherite helmet is crafted')
                ...
                if stats.leggings == 7:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, more shiny meaty wooly netherite leggings is crafted')
                ...
                if stats.boots == 7:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, more shiny meaty wooly netherite boots is crafted')
                ...
                if stats.sword == 7:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, more shiny meaty wooly netherite sword is crafted')
                ...
                if item.pogchop >= 8 and item.coal >= 1:
                    db[stats.userid + 'pogchop'] = item.pogchop - 8
                    db[stats.userid + 'coal'] = item.coal - 1
                    db[stats.userid + 'cooked_pogchop'] = db[stats.userid + 'cooked_pogchop'] + 8
                    await ctx.send(f'**{ctx.author.name}**cooked 8 pogchop')
                elif item.pogchop < 8:
                    await ctx.send(f'**{ctx.author.name}**, how do you cook pogchop without pogchop???**')
                elif item.coal < 1:
                    await ctx.send(f'**{ctx.author.name}**, no fire :(**')
    
            elif arg == 'steak':
                if item.beef >= 8 and item.coal >= 1:
                    db[stats.userid + 'beef'] = item.beef - 8
                    db[stats.userid + 'coal'] = item.coal - 1
                    db[stats.userid + 'steak'] = db[stats.userid + 'steak'] + 8
                    await ctx.send(f'**{ctx.author.name}**cooked 8 steak')
                elif item.beef < 8:
                    await ctx.send(f'**{ctx.author.name}**, how do you cook steak without beef???**')
                elif item.coal < 1:
                    await ctx.send(f'**{ctx.author.name}**, no fire :(**')
                ...
                if item.wool >= 3 and item.wood >= 3:
                    ...
                    await ctx.send(f'**{ctx.author.name}**, bed is crafted')
                elif item.wool < 3:
                    await ctx.send(f'You only have **{item.wool} wool**')
                elif item.wood < 3:
                ...
                if item.blaze_rod >= 1:
                    ...
                    await ctx.send(f'**{ctx.author.name}** powdered a blaze_rod')
                else:
                ...
                if item.blaze_powder >= 1 and item.ender_pearl >= 1:
                    ...
                    await ctx.send(f'**{ctx.author.name}**crafted an eye_of_ender')
                ...
                if item.map_scrap >= 5:
                    ...
                    await ctx.send(f'**{ctx.author.name}** has finished  **sea monument map**')
                else:
                ...
                if item.netherite_scrap >= 4 and item.gold_ingot >= 4:
                    ...
                    await ctx.send(f'**{ctx.author.name}** crafted a **netherite ingot**')
